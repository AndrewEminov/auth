...
func (c *noteV1Client) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateRequest, error) {
...
func (UnimplementedNoteV1Server) Update(context.Context, *UpdateRequest) (*UpdateRequest, error) {
